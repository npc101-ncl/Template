<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="27" versionDevel="217" copasiSourcesModified="0">
  ...
  <ListOfTasks>
    ...
    <Task key="Task_16" name="Scan" type="scan" scheduled="true" updateModel="0">
      <Report append="0" target="/Users/peter/Documents/GitHub/Template/template/copasiRuns/testRun1/Problem1/Fit1/paramiterEstimation/ParameterEstimationData/PEData0.txt" reference="Report_74" confirmOverwrite="0"/>
      <Problem>
        <Parameter name="Subtask" type="unsignedInteger" value="5"/>
        <ParameterGroup name="ScanItems">
        <ParameterGroup name="ScanItem"><Parameter type="unsignedInteger" name="Number of steps" value="1"/><Parameter type="unsignedInteger" name="Type" value="0"/><Parameter type="cn" name="Object" value="CN=Root,Model=NoName,Vector=Compartments[default_compartment],Vector=Metabolites[_A],Reference=InitialConcentration"/></ParameterGroup></ParameterGroup>
      ...
      <Problem>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="FitItem">
            ...
            <Parameter type="cn" name="ObjectCN" value="CN=Root,Model=NoName,Vector=Compartments[default_compartment],Vector=Metabolites[_A],Reference=InitialConcentration"/>
          </ParameterGroup>
        </ParameterGroup>
        <ParameterGroup name="OptimizationConstraintList">
        </ParameterGroup>
        ...
        <ParameterGroup name="Experiment Set">
          <ParameterGroup name="test1">
            <Parameter type="key" name="Key" value="Experiment_test1"/>
            <Parameter type="file" name="File Name" value="/Users/peter/Documents/GitHub/Template/template/copasiRuns/testRun1/test1.csv"/>
            ...
            <Parameter type="unsignedInteger" name="Number of Columns" value="3"/>
            <ParameterGroup name="Object Map">
              ...
              <ParameterGroup name="2">
                <Parameter type="cn" name="Object CN" value="CN=Root,Model=NoName,Vector=Compartments[default_compartment],Vector=Metabolites[_A],Reference=Concentration"/>
